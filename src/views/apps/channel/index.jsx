...
import ChannelDialog from '@components/dialogs/channel-dialog/index'
...
const Channel = () => {
    ...
    const fetchPermissionModule = async () => {
        try {
            const response = await fetch(`${URL}/company/channel`, {
                method: "GET",
                headers: {
    ...
    const columns = useMemo(
        () => [
            ...
            columnHelper.accessor('parent', {
                header: 'Sub Channel',
                cell: ({ row }) => <Typography color='text.primary'>{row.original.parent}</Typography>
            }),
