        ...
        <DialogContent className='flex items-center flex-col text-center sm:pbs-16 sm:pbe-6 sm:pli-16'>
          ...
          >
            <Typography variant='h4'>
              {type === 'delete-account' && `Are you sure you want to delete ${user?.first_name}?`}
      ...
      <Dialog open={secondDialog} onClose={handleSecondDialogClose} closeAfterTransition={false}>
        <DialogContent className='flex items-center flex-col text-center sm:pbs-16 sm:pbe-6 sm:pli-16'>
          ...
          <Typography color='text.primary'>
            {userInput ? (
              <>
                {type === 'delete-account' && `${user?.first_name} has been deleted successfully.`}
              ...
              <>
                {type === 'delete-account' && 'User deletion Cancelled!'}
